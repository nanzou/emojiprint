...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\emojiprint on
     Windows, /home/user/dev/emojiprint on Linux) in a file named
     emojiprint@takaaki.mizuno and copy that file to
